...
import  "./css/registeration-styles.css"
...
function Register({ setData }: { setData: (d: { email: string, time: number, goVerify: boolean }) => void }) {
    ...
    return (
        <div className="register-container" data-aos="flip-left">
            <div className="register-card">
                ...
                <form action="" method="post" onSubmit={handleSubmition} className="register-form" noValidate>

                    <div className="name-row">
                        <div className="form-group">
                            <label className="form-label" htmlFor="firstName">
                                {validateMsg.to === "firstName" ? validateMsg.message : "First name"}
                            </label>
                            <input type="text" id="firstName" name="firstName" className="form-input" placeholder="first name" required />
                        </div>
                        <div className="form-group">
                            <label className="form-label" htmlFor="lastName">
                                {validateMsg.to === "lastName" ? validateMsg.message : "Last name"}
                            </label>
                    ...
                    <div className="form-group">
                        <label className="form-label" htmlFor="password">
                            {validateMsg.to === "password" ? validateMsg.message : "Password"}
                        </label>
