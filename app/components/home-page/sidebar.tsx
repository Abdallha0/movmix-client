...
function Sidebar({ active }: { active?: "home" | "play list" | "profile" | "setting" }) {
    ...
    return (
        <div className={styles.sidebar} >
            ...
            <Link href={name !== "GUEST" ? `/${name.split(" ").join("-")}/profile` : "/login"} className={`${styles.sidebar_icon} ${active === "profile" ? styles.active : ""}`} title="profile"><UserRound /></Link>
